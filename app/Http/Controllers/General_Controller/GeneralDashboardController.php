...
class GeneralDashboardController extends Controller
{
    public function index()
    {
        ...
        $doctors = Doctor::all();
        return view('general_dashboard.index',compact('departments','doctors','first_dept_doctors'));
    }
    ...
    {
        return view('general_dashboard.appointment-form',compact('doctorId','scheduleId'));
    }
    public function appointmentStore(AppointmentRequest $request,$scheduleId, $doctorId)
    {
